...
```
	...
	- The resulting 'change point', health predictions from the change point, the effective clinical stability and the comparative values for the           Weibul predictive curve are printed on the console.
